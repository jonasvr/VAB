function loadSounds(){
    locations.punt1 = new Media("punt1.mp3",
        function () {
    ...
    locations.punt2.sound = new Media("punt2.mp3",
        function () {
            console.log("playAudio():Audio Success");
        },
        // error callback
    ...
    locations.punt3.sound = new Media("punt3.mp3",
        function () {
            console.log("playAudio():Audio Success");
        },
        // error callback
    ...
    locations.punt4.sound = new Media("punt4.mp3",
        function () {
            console.log("playAudio():Audio Success");
        },
        // error callback
    ...
    locations.punt5.sound = new Media("punt5.mp3",
        function () {
            console.log("playAudio():Audio Success");
        },
        // error callback
    ...
    locations.punt6.sound = new Media("punt6.mp3",
        function () {
            console.log("playAudio():Audio Success");
        },
        // error callback
    ...
    locations.punt7.sound = new Media("punt7.mp3",
        function () {
            console.log("playAudio():Audio Success");
        },
        // error callback
    ...
    locations.punt8.sound = new Media("punt8.mp3",
        function () {
            console.log("playAudio():Audio Success");
        },
        // error callback
